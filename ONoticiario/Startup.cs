...
namespace IdentitySample
{
    public partial class Startup
    {
        ...
        private void iniciaAplicacao()
        {
            ...
            Utilizadores utilizador = new Utilizadores {Avatar="default.png",ID=1,Descricao="Administrador da Aplicaçao web",Nome= "Luis Badalo", Username=user.Email,DataNascimento= new DateTime(1997, 9, 29) };
            ...
            Utilizadores utilizador1 = new Utilizadores { Avatar = "default.png", ID = 2, Descricao = "Jornalista da Aplicaçao web", Nome = "Rafael Sousa", Username = user1.Email, DataNascimento = new DateTime(1985, 2, 23) };
